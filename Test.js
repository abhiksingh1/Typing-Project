const str1 = ["1.) Unity refers to the extent to which all of the ideas contained within a given paragraph \"hang together\" in a way that is easy for the reader to \
...
const str2 = ["2.) Employees' attitudes at Jonstone Electric Company should be improved. The workers do not feel that they are a working team instead of just individuals.\
...
const str3 = ["3.) Coherence refers to the extent to which the flow of ideas in a paragraph is easily understood by the reader. For this reason, coherence is closely \
...
const str4 = ["4.) Schools should offer courses to help students with the problems of unemployment. Such a course might begin with a discussion of where to find employment,\
...
const str5 = ["5.) A paragraph is adequately developed when it describes, explains and supports the topic sentence. If the \"promise\" of the topic sentence is not\
...
const str6 = ["6.) \"The topics of leadership and management are both similar to and different from one another in several important ways. To be effective, a manager\
...
Generally speaking, a paragraph should contain between three and five sentences, all of which help clarify and support the main idea of the paragraph. When a writer\
 begins a new paragraph, it signals to the reader that the writer is changing thoughts or ideas, or is moving on to discuss a different aspect of a main idea."];
const str7 = ["7.) Beginning a paragraph with a topic sentence is one of the best ways to achieve clarity and unity in one's writing. The function of a topic sentence \
is to describe what the paragraph will be about, such that the reader has clear expectations about what will follow. An effective topic sentence typically contains\
 only one main idea. The remainder of the paragraph then develops that idea more fully, offering supporting points and examples. After reading a topic sentence, one \
  ...
  the topic sentence, the paragraph will lack unity, coherence and adequate development."];
const str8 = ["8.) \"The cockroaches that inhabit many city apartments and homes are parasites that are almost impossible to exterminate completely.\"\
\
...
anticipate learning more in this paragraph about the specific benefits of organic foods."];
const str9 = ["9.) Someone who weighs more than average can be curvy, well-built, full-bodied or heavy. (Curvy is usually only used to describe women.) You might also say \
...
be thin, slim or skinny."];
const str10 = ["10.) How does a person look overall? If you think a woman is attractive, you can say she is beautiful, pretty or maybe even gorgeous (very beautiful). You \
...
is not very good-looking, you can say they are not much to look at. This is not a nice way to describe someone, but it’s better than ugly."];
const str11 = ["11.) Population is defined as the total number of human beings in a particular city, state, or country. We can calculate approximately the number of \
...
more population as the young children are unaware of the facts related to reproduction."];
const str12 = ["12.) Today we are going to discuss Patriotism Essay in English. Most people don’t know the meaning of Patriotism?  Patriotism means devotion to and \
...
topics. Patriotism essay in English in 100 words to 700 words. Patriotism essay for class 7, 8, 9, 10, 11 and 12. Learn and give your feedback on Patriotism essay."];
const str13 = ["13.) Demonetisation is the act of stripping currency units of its status as a legal tender. It occurs when current forms of money are pulled from \
...
and 1000 banknotes of Mahatma Gandhi series. This is not the first time that India demonetized its currency earlier it was done in 1946 and 1978."];
const str14 = ["14.) According to transparency internationals corruption India, even though India is still the most corrupt country in Asia. Corruption related reposts \
...
so difficulties for a couple of months but this inconvenience shall be temporary and hardship in term may yield benefits in the long term."];
const str15 = ["15.) Cities accommodate 31% of India’s population and contribute 63 per cent of GDP (census 2011). Urban areas are to house 40% of India’s population \
